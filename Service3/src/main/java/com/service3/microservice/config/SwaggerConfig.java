package com.service3.microservice.config;
...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
            ...
            .apis(RequestHandlerSelectors.basePackage("com.service3.microservice.controller"))
    ...
    private ApiInfo generateAPIInfo() {
        return new ApiInfo("Service3 Demo", "Implementing Swagger with SpringBoot Application", "2.0.0",
