package com.service2.microservice.config;
...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
            ...
            .apis(RequestHandlerSelectors.basePackage("com.service2.microservice.controller"))
    ...
    private ApiInfo generateAPIInfo() {
        return new ApiInfo("Service2 Demo", "Implementing Swagger with SpringBoot Application", "2.0.0",
